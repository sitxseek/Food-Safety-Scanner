...
public class ResultFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        barcode = args.getParcelable(BARCODE);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "https://api.nutritionix.com/v1_1/item?upc=" + barcode.displayValue + "&appId=15f0aa3f&appKey=ff47eadb8037bab107ad4a8827359f42";
